...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Minitl Object Template Construct</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link minitlTrace.Steps.impl.Minitl_ObjectTemplate_ConstructImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link minitlTrace.Steps.impl.Minitl_ObjectTemplate_ConstructImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link minitlTrace.Steps.impl.Minitl_ObjectTemplate_ConstructImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Minitl_ObjectTemplate_ConstructImpl extends StepImpl implements Minitl_ObjectTemplate_Construct {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Minitl_ObjectTemplate_Construct_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Minitl_ObjectTemplate_ConstructImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.MINITL_OBJECT_TEMPLATE_CONSTRUCT;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Minitl_ObjectTemplate_Construct_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Minitl_ObjectTemplate_Construct_AbstractSubStep>(Minitl_ObjectTemplate_Construct_AbstractSubStep.class, this, StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Minitl_ObjectTemplate_Construct_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.MINITL_OBJECT_TEMPLATE_CONSTRUCT___GET_CALLER:
				return getCaller();
		}
		return super.eInvoke(operationID, arguments);
	}

} //Minitl_ObjectTemplate_ConstructImpl
