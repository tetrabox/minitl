		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metamodel_packages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metamodel_packages_feature", "_UI_Metamodel_type"),
				 MinitlPackage.Literals.METAMODEL__PACKAGES,
				 true,
				 false,
				 true,
				 null,
