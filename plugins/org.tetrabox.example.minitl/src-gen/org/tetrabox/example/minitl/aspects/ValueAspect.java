...
public abstract class ValueAspect {
  ...
  public static Object evaluate(final Value _self) {
    ...
    Object result = null;
     if (_self instanceof org.tetrabox.example.minitl.minitl.FieldAccessValue){
    ...
    } else  if (_self instanceof org.tetrabox.example.minitl.minitl.ObjectTemplateValue){
    					...
    					result = org.tetrabox.example.minitl.aspects.ValueAspect._privk3_evaluate(_self_, (org.tetrabox.example.minitl.minitl.Value)_self);
